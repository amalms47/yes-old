...
<head>
    ...
    <title>Yescolleges.com | Institute Panel</title>
    ...
    <section class="content" style="margin-top:100px;">
        ...
        <div class="error-page">
            ...
            <div class="error-content">
                <h2 class="headline text-logogreen"></h2>
                <h3><i class="fa fa-warning text-logogreen"></i> Oops! Unsupported browser.</h3>
                <p>Please use Google chrome , Safari or Microsoft Edge with latest version</p>
            </div>
        </div>
    </section>
</div>
