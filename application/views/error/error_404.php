...
<h2 class="headline text-logogreen"> 404</h2>
<div class="error-content">
<h3><i class="fa fa-warning text-logogreen"></i> Oops! Page not found.</h3>
<p>We could not find the page you were looking for.<br>Meanwhile, you may <a href="<?=base_url();?>">return to website</a> or got to previous page.</p>
</div>     
</div>      
</section>
</div>
