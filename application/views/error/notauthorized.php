...
<div class="wrapper">
    <section class="content" style="margin-top:10%;">
        ...
        <div class="error-page">
            <h2 class="headline text-logogreen" style="margin-top:0px;font-size: 120px;"> </h2>
            <div class="error-content" >
                <h3><i class="fa fa-warning text-logogreen" style="margin-top:30px;"></i> You have no permission!</h3>
                <p><br>Meanwhile, you may return to web site </p>
            </div>
        </div>
    </section>
</div>
