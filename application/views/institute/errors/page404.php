...
<h2 class="headline text-logogreen" style="margin-top:0px;font-size: 120px;"> 404</h2>
<div class="error-content" >
<h3><i class="fa fa-warning text-logogreen" style="margin-top:30px;"></i> Oops! Page not found.</h3>
<p>We cannot find page you are looking for   <br>Meanwhile, you may <a href="<?=  base_url();?>institution-login">return to web site</a> or contact administrator</p>
</div>       
</div>      
</section>
</div>
