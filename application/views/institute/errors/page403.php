...
<h2 class="headline text-logogreen" style="margin-top:0px;font-size: 120px;"> 403</h2>
<div class="error-content" >
<h3><i class="fa fa-warning text-logogreen" style="margin-top:30px;"></i> Oops! Forbidden Activity.</h3>
<p>We found that you  made a  forbidden activity  <br>Meanwhile, you may <a href="<?=  base_url();?>institution-login">return to web site</a> or contact administrator</p>
</div>       
</div>      
</section>
</div>
