          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content" style="background-color: #e8eaed">
              ...
              <div class="modal-body" >
                <div class="alert">
                 <h4><i class="icon fa fa-comment"></i> Student Comment/Enquiry!</h4>
                 <div id="smessage"></div>                 
              </div>
              <div class="alert" style="background-color: gray">
                 <h4><i class="icon fa fa-comments-o"></i> Enter Reply Here </h4>
                    <textarea class="form-control" rows="5" placeholder="Enter reply" id="replymsg"></textarea>           
              </div>
               </div>
              <div class="modal-footer">
                    <button type="button" class="btn  btn-sm"  style="background-color:#424344;color:white " id="saveReply" value="-1"><i class="icon fa fa-reply"></i> Send Reply</button>
                  <button type="button" class="btn btn-sm" style="background-color:#424344 ;color:white" data-dismiss="modal" id="enquirydismiss" aria-label="OK"><i class="icon fa fa-check"></i>Cancel</button>
              </div>
            </div>
          </div>
     </div>
...
<script type="text/javascript" src="<?= base_url()?>assets/backend/scripts/in_enquiry.js"></script>
