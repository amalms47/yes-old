                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback">
                                <input type="text" id="searchcollegemail" class="form-control input-sm" placeholder="Search by subject">
...
<script>
    ...
    $("#mailsidebar").css('color','white');
</script>

<script src="<?=base_url();?>assets/backend/scripts/ins_mail.js"></script>
