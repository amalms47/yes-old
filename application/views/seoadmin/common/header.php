...
<head>
    ...
    <title>Yescolleges.com | SeoAdmin</title>
                  ...
                  <!--         <span class="label label-danger">9</span>--
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?=base_url();?>assets/backend/images/adminlogo/none.png" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?=$username; ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="<?=base_url();?>assets/backend/images/adminlogo/none.png" class="img-circle" alt="User Image">
                            ...
                            <li class="user-footer" style="background-color: darkgrey">
                                ...
                                <div class="pull-right">
                                    <a href="<?=base_url()?>Seoadmin/logout" style="background-color: #1f262d; color: #fff" class="btn  "><i class="fa   fa-power-off"> </i> Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
