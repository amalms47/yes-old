    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <h5 class="box-title"><span><b id="reviewcount">0</b>&nbsp;reviews found</span></h5>
...
<script type="text/javascript" src="<?= base_url()?>assets/backend/scripts/adm_reviews.js?kl"></script>
