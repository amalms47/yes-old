$(document).ready(function(){
	...
	var $headerDown = function() {
		...
		header_logo.find('img').attr('src',site_url+'assets/frontend/img/logo-a.png');
	...
	var $headerUp = function() {
		...
		header_logo.find('img').attr('src',site_url+'assets/frontend/img/logo.png');
	}
	...
	$('.nav-student-account a').on('click',function(){
